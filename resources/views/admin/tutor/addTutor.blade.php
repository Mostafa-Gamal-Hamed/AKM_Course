...
@section('Body')
    <h1 class="text-dark text-center font-weight-bold mb-5">Add Tutor</h1>
        ...
        <div class="shadow p-5">
            <form action="{{ route('storeTutor') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="levels" value="{{ old('levels') }}" class="form-control" id="levels"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="absence" value="{{ old('absence') }}" class="form-control"
