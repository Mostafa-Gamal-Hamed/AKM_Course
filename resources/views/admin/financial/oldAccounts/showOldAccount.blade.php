                            ...
                            <tbody>
                                @foreach ($manager1 as $manager)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('editManager', "$manager->id") }}"
                                                class="btn btn-primary btn-sm">Edit</a>
                                        </td>
                                        <td>
                                            <form action="{{ route('deleteManager', "$manager->id") }}" method="post">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <tbody>
                                @foreach ($tutor1 as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->total }}</td>
                                        <td>
                                            <a href="{{ route('editTutor', "$data->id") }}"
                                                class="btn btn-primary btn-sm">Edit</a>
                                        </td>
                                        <td>
                                            <form action="{{ route('deleteTutor', "$data->id") }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                    onclick="return confirm('Are You sure?')">Delete</button>
