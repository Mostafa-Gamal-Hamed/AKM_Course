                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-md-4 col-md-pull-8 animate-box">
                        <div class="mt">
                            ...
                            <p>English is spoken at a useful level by some 1.75 billion people worldwide – that’s one in every four!.</p>
                            <ul class="list-nav">
                                <li><i class="icon-check2"></i>Studying English can help you get a job</li>
                                <li><i class="icon-check2"></i>With English, you can study all over the world</li>
                                <li><i class="icon-check2"></i>English is the language of the media industry</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-4 animate-box">
                        <div class="mt">
                            <div>
                                <h4><i class="icon-user"></i>It is the language of the Internet</h4>
                                <p>English is also a particularly important language online with the highest percentage of content on the internet written in English.
                                    As well as this, some of the world’s largest tech companies are based in English speaking countries. </p>
                            </div>
                            <div>
                                <h4><i class="icon-video2"></i>It will help you to understand other languages</h4>
                                <p>English is one of the easiest languages to learn with its simple alphabet. And once English is mastered you will have developed abilities and practices that you did not have before. </p>
                            </div>
                            <div>
                                <h4><i class="icon-shield"></i>You can learn more than just the language</h4>
                                <p>Good knowledge of English will allow you to access films, music and literature from hundreds of countries around the globe. </p>
                            </div>
                        </div>
                    </div>
