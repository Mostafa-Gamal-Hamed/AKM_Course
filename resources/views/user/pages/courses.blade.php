        ...
        <div class="container bg-light shadow">
            <div class="service flexColumn d-flex justify-content-between align-items-center">
                <div class="column border grid gap-1 text-center p-2 mb-4">
                    ...
                    <h5>{{__("messages.Stand Out In Your Field")}}</h5>
                    <p>{{__("messages.Use the knowledge and skills you have gained to drive impact at work and grow your career.")}}</p>
                </div>
                <div class="column border grid gap-1 text-center p-2 mb-4">
                    <img src="{{asset('images/service2.jpeg')}}" class="img-fluid mb-3" height="125px" width="250px" alt="">
                    <h5>{{__("messages.Learn At Your Own Pace")}}</h5>
                    <p>{{__("messages.On your computer, tablet or phone, online courses make learning flexible to fit your busy life.")}}</p>
                </div>
                <div class="column border grid gap-1 text-center p-2 mb-4">
                    <img src="{{asset('images/service3.png')}}" class="img-fluid mb-3" height="125px" width="250px" alt="">
                    <h5>{{__("messages.Target Your Goals With An Online Course")}}</h5>
                    <p>{{__("messages.Study in your own time and at your own pace. Create the perfect course you need to achieve your goals.")}}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="owl-carousel shadow bg-light">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-md-5 col-sm-12">
                        <div class="new-cars-txt">
                            <h2><a href="#">{{__("messages.COMMUNICATE")}}</a></h2>
                            <p>
                            {{__("messages.Develop the practical communication skills and confidence you need to master real-life situations.")}}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-item">
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-md-5 col-sm-12">
                        <div class="new-cars-txt">
                            <h2><a href="#">{{__("messages.IMPROVE")}}</a></h2>
                            <p>
                            {{__("messages.Enjoy online activities to improve your language skills in your own time. Then work in small groups with your expert teacher and classmates in live online classes.")}}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-item">
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-md-5 col-sm-12">
                        <div class="new-cars-txt">
                            <h2><a href="#">{{__("messages.CUSTOMISE")}}</a></h2>
                            <p>
                            {{__("messages.Live online classes are scheduled throughout the day, everyday, so you can choose to study what you want, when you want.")}}
                            </p>
                        </div>
                    </div>
                </div>
